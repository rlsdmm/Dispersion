...
/**
	 * The Template for printing out a manga property (Release) in Manga Detail page
	 *
	 * This template can be overridden by copying it to your-child-theme/madara-core/single/info-release.php
	 *
