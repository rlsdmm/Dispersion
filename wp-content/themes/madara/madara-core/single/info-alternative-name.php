<?php
	...
	/**
	 * The Template for printing out a manga property (Alternative Name) in Manga Detail page
	 *
	 * This template can be overridden by copying it to your-child-theme/madara-core/single/info-alternative-name.php
	 *
