<?php
	...
	$madara_image_sizes = array(
		...
		'madara_manga_big_thumb_full' => array(
			...
			476,
			true,
			esc_html__( 'Thumb 350x476px', 'madara' ),
			esc_html__( 'This thumb size is used for Manga\'s Big Thumbnail item layout in Manga Archives page when using full-width mode for mobile', 'madara' )
		)
	);
